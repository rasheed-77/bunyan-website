    ...
    <section className="py-20 md:py-24 px-4 sm:px-6 lg:px-32 bg-gradient-to-l from-[#27231e] via-dark to-[#141414] text-white">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-stretch sm:items-center flex-wrap">
          <Link
            href="/Contact_us"
            className="inline-flex justify-center items-center rounded-xl bg-primary text-dark font-bold px-8 py-3.5 hover:bg-[#c8a574] transition shadow-sm"
          >
            تواصل معنا
          </Link>
          <Link
          ...
          <a
            ...
            className="inline-flex justify-center items-center gap-2 rounded-xl bg-primary text-dark font-bold px-8 py-3.5 hover:bg-[#c8a574] transition shadow-sm"
          >
